...
import { existsSync as existsSync4, mkdirSync as mkdirSync6, readFileSync as readFileSync7, renameSync as renameSync2, writeFileSync as writeFileSync5 } from "node:fs";
...
function findHivemindOnPath() {
  ...
  for (const dir of dirs) {
    const candidate = join11(dir, "hivemind");
...
var { log: wikiLog } = makeWikiLogger(join12(homedir9(), ".claude", "hooks"));
async function main() {
  ...
  if (embeddingsDisabled()) {
    ...
    try {
      const daemonEntry = join12(__bundleDir, "embeddings", "embed-daemon.js");
