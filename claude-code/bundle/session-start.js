...
import { existsSync as existsSync8, readFileSync as readFileSync9, writeFileSync as writeFileSync7, mkdirSync as mkdirSync8, renameSync as renameSync4, lstatSync as lstatSync2, readlinkSync, symlinkSync, unlinkSync as unlinkSync4 } from "node:fs";
import { homedir as homedir9 } from "node:os";
import { dirname as dirname4, join as join15 } from "node:path";

// dist/src/skillify/skill-writer.js
import { existsSync as existsSync4, mkdirSync as mkdirSync6, readFileSync as readFileSync7, readdirSync, statSync as statSync2, writeFileSync as writeFileSync5 } from "node:fs";
...
import { existsSync as existsSync6, lstatSync, mkdirSync as mkdirSync7, readFileSync as readFileSync8, renameSync as renameSync3, unlinkSync as unlinkSync3, writeFileSync as writeFileSync6 } from "node:fs";
...
function migrateLegacyStateDir() {
  ...
  const legacy = join12(dirname2(current), "skilify");
...
import { existsSync as existsSync9, mkdirSync as mkdirSync9, readFileSync as readFileSync10, writeFileSync as writeFileSync8 } from "node:fs";
...
import { closeSync as closeSync2, existsSync as existsSync10, mkdirSync as mkdirSync10, openSync as openSync2, readdirSync as readdirSync2, statSync as statSync3, unlinkSync as unlinkSync5 } from "node:fs";
...
function maybeAutoMineLocal() {
  ...
  try {
    mkdirSync10(HIVEMIND_DIR, { recursive: true });
  ...
  try {
    mkdirSync10(join17(HOME, ".claude", "hooks"), { recursive: true });
...
import { appendFileSync as appendFileSync3, existsSync as existsSync12, mkdirSync as mkdirSync12, readFileSync as readFileSync12 } from "node:fs";
...
var HOME2 = homedir13();
var { log: wikiLog } = makeWikiLogger(join23(HOME2, ".claude", "hooks"));
