...
import { existsSync as existsSync8, mkdirSync as mkdirSync10, writeFileSync as writeFileSync9 } from "node:fs";
import { homedir as homedir11 } from "node:os";
import { join as join16, dirname as dirname7, sep } from "node:path";
...
var SHELL_BUNDLE = existsSync8(join16(__bundleDir, "shell", "deeplake-shell.js")) ? join16(__bundleDir, "shell", "deeplake-shell.js") : join16(__bundleDir, "..", "shell", "deeplake-shell.js");
var READ_CACHE_ROOT = join16(homedir11(), ".deeplake", "query-cache");
function writeReadCacheFile(sessionId, virtualPath, content, deps = {}) {
  ...
  const expectedRoot = join16(cacheRoot, safeSessionId, "read");
  const absPath = join16(expectedRoot, rel);
  ...
  mkdirSync10(dirname7(absPath), { recursive: true });
  writeFileSync9(absPath, content, "utf-8");
  return absPath;
}
