...
Used by wiki-worker-bee to mirror structure, tone, and frontmatter completeness when authoring real pages.

**Status:** populated in the next stinger-forge pass after research completes. Tracked in `research/research-plan.md`.
