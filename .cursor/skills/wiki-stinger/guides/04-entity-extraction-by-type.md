...
**Gotchas:**
- The module narrative document (the longer-form prose) is library-worker-bee's job at `library/knowledge-base/<module>/`. wiki-worker-bee's `module` entity is a stub-style index pointing at the per-callable entities inside the file.
