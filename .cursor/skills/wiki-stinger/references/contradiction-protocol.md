...
Pattern derived from `gods-hand/refs/claude-obsidian-main/skills/wiki-ingest/SKILL.md` (Contradictions section + custom callout vocabulary). Active extension (Artifacts 3 + 4) added per the wiki-worker-bee Command Brief, "EXPECTED OUTPUT" + Phase 6.
