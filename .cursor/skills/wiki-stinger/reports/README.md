...
- The actual contradiction reports for any specific repo — those live at `library/knowledge-base/wiki/meta/` inside that repo.
...
**Status:** populated as wiki-worker-bee runs and generates real reports. Tracked alongside `examples/`.
