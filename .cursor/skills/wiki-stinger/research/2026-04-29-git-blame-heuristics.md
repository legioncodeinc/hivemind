...
Wiki-worker-bee itself does NOT run git. The TS driver pre-computes `git_context` per file and hands it to the agent in the canonical-path payload. Per the Command Brief, `git_context` includes:
