...
Source brief: [`legion/command-briefs/wiki-worker-bee-command-brief.md`](../../../../command-briefs/wiki-worker-bee-command-brief.md)
...
Sibling stinger for style mirroring: `legion/.cursor/skills/library-stinger/`.
