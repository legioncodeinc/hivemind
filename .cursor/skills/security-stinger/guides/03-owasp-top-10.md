...
The OWASP Top 10 refreshed in 2025 (`research/2026-04-24-owasp-top-10-2025.md`). Two new categories (Supply Chain Failures, Mishandling of Exceptional Conditions) and SSRF consolidated into Broken Access Control. The catalog below keeps every pattern from the Bee body and re-slots them against the 2025 list so the Stinger stays current.
