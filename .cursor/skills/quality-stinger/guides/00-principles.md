...
- Other Bees may exist (`ux-ui-worker-bee`, `seo-worker-bee`, etc.). `quality-worker-bee` does not substitute for them. If the plan references a UX or SEO concern, confirm it is present but defer deep audit of it to the specialist Bee.
