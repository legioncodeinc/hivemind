...
- **Source breadth target:** official docs, SDK npm page, community blog posts, MCP spec, internal Legion rule files and MCP configs
...
4. The gods-hand-stinger structure (referenced in Command Brief as cross-reference)
