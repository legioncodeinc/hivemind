...
- The EPPO "link richly" principle is a structural recommendation that interacts with the Bee's scope boundary: the Bee can recommend links, but cannot restructure the site navigation (that is docs-site-worker-bee's job).
