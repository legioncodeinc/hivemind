#!/usr/bin/env node
// Phase-0 probe for Hermes. Hermes on_session_start expects
// JSON.stringify({ context: "..." }) on stdout.
...
process.stdin.on("end", () => {
  ...
  process.stdout.write(JSON.stringify({
    context: `${stdoutToken}\n\nIf this appears as a SEPARATE context block from the hivemind one, multi-command separation works in Hermes.`,
  }));
});
