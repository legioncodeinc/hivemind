/**
 * Remove skills previously installed by `hivemind skilify pull`.
 *
 * Source of truth: `~/.deeplake/state/skilify/pulled.json` (the manifest
 ...
 *                 `<16-hex>/` (old project_key layout from skilify ≤ v0.7.13)
 *                 and remove them.
 *
